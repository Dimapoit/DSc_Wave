...
<section class="ftco-about d-md-flex bg-light">
    <div class="one-half img" style="background-image: url('{{asset('images/about_1.jpg')}}');">
        <a href={{$video[0]->link_video}} class="about-video icon d-flex justify-content-center align-items-center" target="_blank">
            <span class="icon-play"></span>
        </a>
{{--        <button type="button" class="icon d-flex justify-content-center align-items-center" data-toggle="modal" data-target="#videoModal" data-video="https://www.youtube.com/embed/oOeS5dvKns4">Video</button>--}}

{{--        <a href="https://www.youtube.com/embed/oOeS5dvKns4" id="about-video" class="icon d-flex justify-content-center align-items-center">--}}
{{--            <span class="icon-play"></span>--}}
{{--        </a>--}}
