...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 10 2020 г., 22:38
...
(1, 'Найбільші та комфортні танцювальні зали у місті', 'Самые большие и комфортные танцевальные залы в городе', NULL, NULL),
(2, 'Найпотужніша тренерська команда професіоналів - фанатів своєї справи', 'Мощнейшая тренерская команда профессионалов - фанатов своего дела', NULL, NULL),
(3, 'Магазин та ательє спеціалізованого танцювального одягу', 'Магазин и ателье специализированной танцевальной одежды', NULL, NULL),
(4, 'Індивідуальний підхід до розвитку Вас або Вашої дитини', 'Индивидуальный подход к развитию Вас или Вашего ребенка', NULL, NULL),
(5, 'Фреш-бар, кафе', 'Фреш-бар, кафе', NULL, NULL);
...
(1, 'https://www.facebook.com/FeyeriaDanceSportClub/', 'https://www.instagram.com/mariupol_dancesport/', 'СК Іллічівець, східна трибуна, проспект Нахімова, 53, ТСЦ Wave Маріуполь', 'СК Ильичевец, восточная трибуна, проспект Нахимова, 53, ТСЦ Wave Мариуполь', '+380985674170', 'nazarshashkov@gmail.com', NULL, NULL);
...
(1, 'images/gallery/gallery_1.jpg', 1, NULL, NULL),
(2, 'images/gallery/gallery_2.jpg', 1, NULL, NULL),
(3, 'images/gallery/gallery_3.jpg', 1, NULL, NULL),
(4, 'images/gallery/gallery_4.jpg', 1, NULL, NULL),
(5, 'images/gallery/gallery_5.jpg', 1, NULL, NULL),
(6, 'images/gallery/gallery_6.jpg', 1, NULL, NULL),
(7, 'images/gallery/gallery_7.jpg', 1, NULL, NULL),
(8, 'images/gallery/gallery_8.jpg', 1, NULL, NULL),
(9, 'images/gallery/gallery_9.jpg', 1, NULL, NULL),
(10, 'images/gallery/gallery_10.jpg', 1, NULL, NULL),
(11, 'images/gallery/gallery_11.jpg', 1, NULL, NULL),
(12, 'images/gallery/gallery_12.jpg', 1, NULL, NULL),
(13, 'images/gallery/gallery_13.jpg', 1, NULL, NULL),
(14, 'images/gallery/gallery_14.jpg', 1, NULL, NULL),
(15, 'images/gallery/gallery_15.jpg', 1, NULL, NULL);
...
(1, 'images/logo/audsf.png', 'https://audsf.com.ua/news/', 1, NULL, NULL),
(2, 'images/logo/scu.png', 'https://scu.org.ua/', 1, NULL, NULL),
(3, 'images/logo/noc.png', 'http://noc-ukr.org/', 1, NULL, NULL),
(4, 'images/logo/mincult.png', 'https://mkip.gov.ua/ru/', 1, NULL, NULL),
(5, 'images/logo/wdsf.png', 'https://www.worlddancesport.org/', 1, NULL, NULL),
(6, 'images/logo/msport.png', 'https://www.facebook.com/msportukraine/', 1, NULL, NULL);
...
(1, 'images/slider/wave_1.jpg', 'focus on the next wave', 'Be One Of Us', 1, NULL, NULL),
(2, 'images/slider/wave_2.jpg', 'Challenge Yourself', 'Be One Of Us', 1, NULL, NULL),
(3, 'images/slider/wave_3.jpg', 'Life\'s a wave, catch it...', 'Be One Of Us', 1, NULL, NULL);
